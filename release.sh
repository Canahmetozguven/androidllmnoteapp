#!/bin/bash
# Release script for Android with Vulkan
# Builds both APK and AAB, then copies artifacts to a convenient location
set -e
...
./gradlew clean :app:assembleRelease :app:bundleRelease -PuseVulkan=true
