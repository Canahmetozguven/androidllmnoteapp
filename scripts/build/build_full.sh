...
# 
# Usage:
#   ./scripts/build/build_full.sh static    # Build with static backends (default)
#   ./scripts/build/build_full.sh dynamic   # Build with dynamic backend loading (dlopen)
#   ./scripts/build/build_full.sh clean     # Clean build artifacts
#
set -e

# === Configuration ===
BUILD_MODE="${1:-static}"  # static, dynamic, clean
BUILD_TYPE="Release"
